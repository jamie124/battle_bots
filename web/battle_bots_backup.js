...
var stats, scene, camera, light, ground, groundGeometry, groundMaterial;
...
function init() {
	...
	heightImg.onload = function () {
        ...
        // Load terrain mesh
        /*
        groundGeometry = new THREE.PlaneGeometry( 7500, 7500, worldWidth - 1, worldDepth - 1 );

        groundGeometry.applyMatrix( new THREE.Matrix4().makeRotationX( - Math.PI / 2 ) );

        for ( var i = 0, l = groundGeometry.vertices.length; i < l; i ++ ) {

            groundGeometry.vertices[ i ].z = data[ i ] * 10;

         //   if (data[i] > home.y) {
            //    home.x = groundGeometry.vertices[i].x;
           //     home.y = groundGeometry.vertices[i].y;
           //     home.z = groundGeometry.vertices[i].z;
           // }
        }
        */
        ...
        groundGeometry = new THREE.PlaneGeometry( 75, 75, 50, 50 );
        ...
        // Setup ground
		ground = new Physijs.HeightfieldMesh( groundGeometry, groundMaterial,
            0, // Mass
            50,
            50);
